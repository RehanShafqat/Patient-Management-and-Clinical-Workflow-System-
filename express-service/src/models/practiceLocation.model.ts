...
export class PracticeLocation extends Model<InferAttributes<PracticeLocation>, InferCreationAttributes<PracticeLocation>> {
  ...
  declare appointments?: NonAttribute<import('./appointment.model').Appointment[]>;
  declare doctorProfiles?: NonAttribute<import('./doctorProfile.model').DoctorProfile[]>;

  static associate(models: Record<string, any>): void {
    PracticeLocation.hasMany(models.PatientCase, { foreignKey: 'practice_location_id', as: 'patientCases' });
    PracticeLocation.hasMany(models.Appointment, { foreignKey: 'practice_location_id', as: 'appointments' });
    PracticeLocation.hasMany(models.DoctorProfile, { foreignKey: 'practice_location_id', as: 'doctorProfiles' });
  }
